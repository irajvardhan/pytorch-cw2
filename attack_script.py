...
def get_args():
    ...
    parser.add_argument('--source-class', type=int, default=0, help='Source class')
    parser.add_argument('--batch-size', type=int, default=20, help='Batch size to create adversarial examples')
    parser.add_argument('--iterations', type=int, default=0, help='Iteration number to start from')
    parser.add_argument('--thresh-iterations', type=int, default=5, help='Maximum number of iterations to perform')
...
if __name__ == '__main__':
    ...
    print('running the attack script for dataset {}. Creating attack samples from source class {} targeting class {}. We will start processing from iteration {} and go upto {} iterations'.format(args.dataset, args.source_class, target_class, args.iterations, args.thresh_iterations))
    ...
    i = args.batch_size * args.iterations # e.g., if we are starting fresh, i= 20x0=0; 
    # if 1 iteration has passed i = 20x1 = 20
